      ...
      -->
        ...
        <main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
          <div class="text-center">
            ...
            >
              <span class="block xl:inline">Articls to enrich your</span>
              <span class="block text-indigo-600 xl:inline"> Knowledge</span>
            </h1>
            <div
              class="mt-5 mb-3 max-w-md mx-auto text-base font-bold sm:flex sm:justify-center md:mt-8"
            >
              A writer never has a vacation. For a writer life consists of
              either writing or thinking about writing.
            </div>
            <router-link to="/edit-blog">
              <button
                type="submit"
                class="inline-flex justify-center py-2 px-6 border text-base border-transparent shadow-sm text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                Write a blog
              </button>
            </router-link>
...
export default {
  ...
  computed: {
    ...
    ...mapState(
      'app',
      ['networkOnLine', 'appTitle', 'appShortTitle'],
      'authentication',
      ['user']
    )
  }
