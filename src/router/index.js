...
const router = new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      name: 'blogs',
      component: () =>
        import(/* webpackChunkName: "client-chunk-blogs" */ '@/views/Blogs.vue')
    },
    {
      path: '/blogs/:id',
      name: 'blog',
    ...
    {
      path: '/highlight-words',
      name: 'HighlightWords',
      component: () =>
        import(/* webpackChunkName: "client-chunk-edit-blogs" */ '@/views/HighlightWords.vue')
    },
    { path: '*', redirect: '/home' }
  ]
})
